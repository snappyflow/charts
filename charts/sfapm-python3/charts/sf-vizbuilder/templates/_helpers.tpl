...
*/}}
{{- define "sfapm.name" -}}
{{- default .Chart.Name1 .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- else }}
{{- $name := default .Chart.Name1 .Values.nameOverride }}
...
*/}}
{{- define "sfapm.chart" -}}
{{- printf "%s-%s" .Chart.Name1 .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}
